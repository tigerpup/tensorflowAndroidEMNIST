...
public class DrawView extends View {
    ...
    public int[] getPixelData() {
        ...
        //Only for EMNIST : Make sure you rotate images
        Bitmap newBitmap=reorientImage(mOffscreenBitmap);
...
//        mOffscreenBitmap.getPixels(pixels, 0, width, 0, 0, width, height);
   ...
   public Bitmap reorientImage(Bitmap input){
       Matrix matrix = new Matrix();
       matrix.preScale(-1.0f, 1.0f);
       matrix.postRotate(270);
       Bitmap bOutput = Bitmap.createBitmap(input, 0, 0, input.getWidth(), input.getHeight(), matrix, true);
       return bOutput;
    }
}
